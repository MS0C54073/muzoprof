...
export function CourseraIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      fill="currentColor"
    >
      <path d="M11.996 0a12 12 0 0 0-9.2 19.704l3.191-3.19a7.5 7.5 0 1 1 0-9.028l-3.191-3.19A12 12 0 1 0 11.996 24c3.486 0 6.643-1.488 8.86-3.876l-3.364-3.363a7.5 7.5 0 0 1-5.496 2.44 7.5 7.5 0 0 1 0-15 7.5 7.5 0 0 1 5.496 2.44l3.364-3.363A11.96 11.96 0 0 0 11.996 0z"/>
    </svg>
  );
}
