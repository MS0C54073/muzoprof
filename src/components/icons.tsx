...
export function CourseraIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      fill="currentColor"
    >
      <path d="M12.018 19.124c-1.748 0-3.327-.55-4.595-1.488l1.116-1.363c.961.684 2.148 1.101 3.479 1.101 2.13 0 3.738-1.266 3.738-3.136 0-1.87-1.608-3.136-3.738-3.136-1.331 0-2.518.417-3.479 1.101l-1.116-1.363c1.268-.938 2.847-1.488 4.595-1.488 3.413 0 5.86 2.046 5.86 5.125 0 3.079-2.447 5.125-5.86 5.125z" />
    </svg>
  );
}
