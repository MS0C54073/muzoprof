...
export function CourseraIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      fill="currentColor"
    >
      <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12c3.314 0 6.314-1.343 8.485-3.515l-3.535-3.535C15.657 18.243 13.907 19 12 19c-3.866 0-7-3.134-7-7s3.134-7 7-7c1.907 0 3.657.757 4.95 2.05l3.535-3.535C18.314 1.343 15.314 0 12 0z" />
    </svg>
  );
}
